...
public class ManualUlysses extends Ulysses {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualulysses);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/ulysses_manual.pdf")); //Normal File loaction
