...
//                OpsinResult result = nts.parseChemicalName("acetamide", ntsconfig);
                    ...
                    String smiles = result.getSmiles();
                        ...
                        com.jrummyapps.android.shell.Shell.SH.run("export HOME=/data/data/cz.jh.qcd/files ; cd $HOME ; export BABEL_DATADIR=$HOME/database/openbabel ; "+getApplicationInfo().nativeLibraryDir+"/libobabel.so -ismi temp.smi -oxyz --gen3d > structure.xyz");
                        String XYZfile = exec("cat "+getFilesDir()+"/structure.xyz");
...
//                    String stdinchi = NameToInchi.convertResultToStdInChI(result);
                    ...
                    outputWriter3.write(smiles+"\n\n");
                    outputWriter3.write("XYZ:\n");
                    outputWriter3.write(XYZfile+"\n");
                    outputWriter3.close();
