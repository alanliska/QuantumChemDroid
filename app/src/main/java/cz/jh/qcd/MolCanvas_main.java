...
public class MolCanvas_main extends AppCompatActivity {
    ...
    private Button toOcc;
    private Button toUlysses;
    private Button toBias;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toOcc = (Button) findViewById(R.id.toOcc);
        toOcc.setOnClickListener(toOccClick);
        toUlysses = (Button) findViewById(R.id.toUlysses);
        toUlysses.setOnClickListener(toUlyssesClick);
        toBias = (Button) findViewById(R.id.toBias);
        toBias.setOnClickListener(toBiasClick);
...
//                .setView(scrollview)
    ...
    private View.OnClickListener toOccClick; {
        toOccClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                new Thread() {
                    public void run() {
                        ...
                        exec("mv "+getFilesDir()+File.separator+"input.xyz "+getFilesDir()+File.separator+"Occ");
                        Intent intent = new Intent(MolCanvas_main.this, Occ.class);
                        startActivity(intent);
                        molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                        onFinish();
                    }
    ...
    private View.OnClickListener toUlyssesClick; {
        toUlyssesClick = new View.OnClickListener() {
            public void onClick(View v) {
                ProgressDialog progressDialog = new ProgressDialog(MolCanvas_main.this);
                progressDialog.setTitle("Please wait...");
                progressDialog.setMessage("Generating the XYZ file...");
                ...
                new Thread() {
                    public void run() {
                        ...
                        exec("mv "+getFilesDir()+File.separator+"input.xyz "+getFilesDir()+File.separator+"Ulysses");
                        Intent intent = new Intent(MolCanvas_main.this, Ulysses.class);
                        startActivity(intent);
                        molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                        onFinish();
                    }
    ...
    private View.OnClickListener toBiasClick; {
        toBiasClick = new View.OnClickListener() {
            public void onClick(View v) {
                ProgressDialog progressDialog = new ProgressDialog(MolCanvas_main.this);
                progressDialog.setTitle("Please wait...");
                progressDialog.setMessage("Generating the XYZ file...");
                ...
                new Thread() {
                    public void run() {
                        ...
                        exec("mv "+getFilesDir()+File.separator+"md_bias_mol.tmp "+getFilesDir()+File.separator+"Ulysses");
                        Intent intent = new Intent(MolCanvas_main.this, Ulysses.class);
                        startActivity(intent);
                        molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                        onFinish();
